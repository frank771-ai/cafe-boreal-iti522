...
Equipo: Esteban Molina y Franklin Castillo. Fecha: 13 de agosto de 2026.

| Hora CR | Hito | Responsable | Evidencia esperada |
|---|---|---|---|
| 13:18 | Revisión de caso, rúbrica y criterios | Ambos | documento fuente revisado |
| 13:35 | Arquitectura y selección tecnológica | Ambos | `ARQUITECTURA.md` |
| 14:00 | APIs, cifrado y panel administrativo | Esteban / Franklin | código en `source/` |
| 14:40 | Kubernetes, Nginx y scripts one-click | Ambos | `deploy/` |
| 15:20 | Seguridad, SLA, runbook y decisiones | Ambos | `docs/` |
